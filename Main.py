...
def main():
    ...
    parser.add_argument("--prof", type=int, default=4, help="Profundidade máxima da IA") # a padrao é 4, mas pode mudar no terminal ali pra testes só na hora de colocar tem que ser tipo: --prof x --tempo x 
